...
namespace ParsetCrawler.DAL
{
    ...
    partial void InsertCrawlManager(CrawlManager instance);
    partial void UpdateCrawlManager(CrawlManager instance);
    partial void DeleteCrawlManager(CrawlManager instance);
    partial void InsertCrawlLog(CrawlLog instance);
    partial void UpdateCrawlLog(CrawlLog instance);
    partial void DeleteCrawlLog(CrawlLog instance);
    ...
    partial void DeleteItemRates(ItemRates instance);
		...
		public System.Data.Linq.Table<CrawlManager> CrawlManagers
		{
			get
			{
				return this.GetTable<CrawlManager>();
			}
		}
		
		public System.Data.Linq.Table<CrawlLog> CrawlLogs
		{
			get
			{
				return this.GetTable<CrawlLog>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CrawlManager")]
	public partial class CrawlManager : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _IsCrawled;
    ...
    partial void OnIsCrawledChanging(System.Nullable<bool> value);
    partial void OnIsCrawledChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsCrawled", DbType="Bit")]
		public System.Nullable<bool> IsCrawled
		{
			get
			{
				return this._IsCrawled;
			}
			set
			{
				if ((this._IsCrawled != value))
				{
					this.OnIsCrawledChanging(value);
					this.SendPropertyChanging();
					this._IsCrawled = value;
					this.SendPropertyChanged("IsCrawled");
					this.OnIsCrawledChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CrawlLogs")]
	public partial class CrawlLog : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _CrawlTime;
    ...
    partial void OnCodeChanging(int value);
    partial void OnCodeChanged();
    partial void OnCrawlTimeChanging(System.Nullable<System.DateTime> value);
    partial void OnCrawlTimeChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CrawlTime", DbType="DateTime")]
		public System.Nullable<System.DateTime> CrawlTime
		{
			get
			{
				return this._CrawlTime;
			}
			set
			{
				if ((this._CrawlTime != value))
				{
					this.OnCrawlTimeChanging(value);
					this.SendPropertyChanging();
					this._CrawlTime = value;
					this.SendPropertyChanged("CrawlTime");
					this.OnCrawlTimeChanged();
				}
			}
		}
